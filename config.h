...
static const char *fonts[]          = { "Cascadia Code:size=10", "JoyPixels:size=10"};
...
static const char col_gray3[]       = "#dddddd"; // Unselected Font Color Tag
...
static const char *emojiselectorcmd[] = { "emojiselector", NULL };
...
static const Key keys[] = {
	...
	{ 0,                      	XF86XK_PowerOff,      spawn,          {.v = sleepcmd } },
	{ ControlMask,                  XK_b,     spawn,          {.v = chromiumcmd } },
	{ MODKEY,                  	XK_n,     spawn,          {.v = thunarcmd } },
	{ MODKEY,                  	XK_e,     spawn,          {.v = emojiselectorcmd } },
